...
const VERTICES: &[Vertex] = &[
    Vertex {
        ...
        tex_coords: [0.131759, 0.99240386],
    }, // A
    Vertex {
    ...
    Vertex {
        ...
        tex_coords: [0.7081453, 0.2060294],
    }, // C
    Vertex {
        position: [0.35966998, -0.3473291, 0.0],
        tex_coords: [0.15967, 0.526709],
    }, // D
    Vertex {
        position: [0.44147372, 0.2347359, 0.0],
        tex_coords: [0.214737, 0.7347359],
    }, // E
];
...
impl<'a> ApplicationHandler for WGPUApp<'a> {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        let diffuse_bytes = include_bytes!("../res/blackHole.jpeg");
